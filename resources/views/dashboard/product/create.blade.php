...
<div class="mt-3 row g-3 align-items-center" style="width: 40rem">
    <form action="/dashboard/products" method="POST">
        ...
        <div class="col-auto">
            ...
            <input type="text" name="merk" id="merk" class="form-control" placeholder="Merk Barang">
        </div>
        <div class="col-auto">
        ...
        <div class="col-auto">
            ...
            <input type="text" name="buy_price" id="buy_price" class="form-control" placeholder="Harga Beli">
        </div>
        <div class="col-auto">
            <label for="" class="form-label">Harga Jual</label>
            <input type="text" name="sell_price" id="sell_price" class="form-control" placeholder="Harga Jual">
        </div>
        <div class="col-auto">
